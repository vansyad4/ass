		...
		<div class="container">
			<div class="single">
				...
				<div class="content-top-in">
					...
					<div class="clearfix">
                        <asp:DetailsView ID="DetailsView1" runat="server" AllowPaging="True" AutoGenerateRows="False" DataKeyNames="MaHoaDon" DataSourceID="SqlDataSource1" Height="81px" Width="176px">
                            <Fields>
                        ...
                        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConflictDetection="CompareAllValues" ConnectionString="<%$ ConnectionStrings:Nhom7 (1)ConnectionString %>" DeleteCommand="DELETE FROM [ChiTietHoaDon] WHERE [MaHoaDon] = @original_MaHoaDon AND [SoLuong] = @original_SoLuong AND [MaSp] = @original_MaSp AND [HoaDon_MaHoaDon] = @original_HoaDon_MaHoaDon AND [SanPham_MaSp] = @original_SanPham_MaSp" InsertCommand="INSERT INTO [ChiTietHoaDon] ([MaHoaDon], [SoLuong], [MaSp], [HoaDon_MaHoaDon], [SanPham_MaSp]) VALUES (@MaHoaDon, @SoLuong, @MaSp, @HoaDon_MaHoaDon, @SanPham_MaSp)" OldValuesParameterFormatString="original_{0}" SelectCommand="SELECT [MaHoaDon], [SoLuong], [MaSp], [HoaDon_MaHoaDon], [SanPham_MaSp] FROM [ChiTietHoaDon]" UpdateCommand="UPDATE [ChiTietHoaDon] SET [SoLuong] = @SoLuong, [MaSp] = @MaSp, [HoaDon_MaHoaDon] = @HoaDon_MaHoaDon, [SanPham_MaSp] = @SanPham_MaSp WHERE [MaHoaDon] = @original_MaHoaDon AND [SoLuong] = @original_SoLuong AND [MaSp] = @original_MaSp AND [HoaDon_MaHoaDon] = @original_HoaDon_MaHoaDon AND [SanPham_MaSp] = @original_SanPham_MaSp">
                            <DeleteParameters>
                                ...
                                <asp:Parameter Name="original_HoaDon_MaHoaDon" Type="String" />
